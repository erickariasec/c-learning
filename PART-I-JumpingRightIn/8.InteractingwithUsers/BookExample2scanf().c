...
// You can let the user type characters other than data values.
// You have to trust the user to type things just right.
// If the user doesn’t type in the dollar sign before the price of the pizza, the program will not function properly.
